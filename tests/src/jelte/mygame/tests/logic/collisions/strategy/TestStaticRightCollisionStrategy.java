...
public class TestStaticRightCollisionStrategy {

	private StaticRightCollisionStrategy strategy;

	@Before
	public void beforeEverytest() {
		strategy = new StaticRightCollisionStrategy();
	}
	...
	public void testResolvePossibleCollision() {
		...
		StaticBlockRight staticCollidable = new StaticBlockRight(x, y, width, height);
		...
		assertEquals(COLLIDABLE_TYPE.STATIC_RIGHT.name(), dynamicCollidable.getCollidedWith().get(0).name());
