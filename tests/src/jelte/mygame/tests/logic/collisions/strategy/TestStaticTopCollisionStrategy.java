...
public class TestStaticTopCollisionStrategy {

	private StaticTopCollisionStrategy strategy;

	@Before
	public void beforeEverytest() {
		strategy = new StaticTopCollisionStrategy();
	}
	...
	public void testResolvePossibleCollision() {
		...
		assertEquals(COLLIDABLE_TYPE.STATIC_TOP.name(), dynamicCollidable.getCollidedWith().get(0).name());
