...
public class TestCharacterStateSprinting {
	...
	public void testHandleEventLeftPressed() {
		...
		verify(characterStateManager).accelerateCharacterX(Direction.left, Constants.SPRINT_SPEED);
	}
	...
	public void testHandleEventRightPressed() {
		...
		verify(characterStateManager).accelerateCharacterX(Direction.right, Constants.SPRINT_SPEED);
	}
