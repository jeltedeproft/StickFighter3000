...
import jelte.mygame.logic.character.state.CharacterStateWalking;
import jelte.mygame.logic.physics.PlayerPhysicsComponent;
import jelte.mygame.tests.testUtil.GdxTestRunner;
import jelte.mygame.utility.logging.MultiFileLogger;

@RunWith(GdxTestRunner.class)
public class TestCharacterStateWalking {

	private CharacterStateManager characterStateManager;
	private CharacterStateWalking characterState;
	...
	public void setup() {
		...
		characterState = new CharacterStateWalking(characterStateManager);
