...
import jelte.mygame.logic.character.state.CharacterStateStopRunning;
import jelte.mygame.tests.testUtil.GdxTestRunner;
import jelte.mygame.utility.Constants;
import jelte.mygame.utility.logging.MultiFileLogger;

@RunWith(GdxTestRunner.class)
public class TestCharacterStateStopRunning {

	private CharacterStateManager characterStateManager;
	private CharacterStateStopRunning characterState;
	...
	public void setup() {
		...
		characterState = new CharacterStateStopRunning(characterStateManager, duration);
	}
