...
import jelte.mygame.logic.character.state.CharacterStateHoldingToSliding;
...
public class TestCharacterStateHoldingToSliding {

	private CharacterStateManager characterStateManager;
	private CharacterStateHoldingToSliding characterState;
	...
	public void setup() {
		...
		characterState = new CharacterStateHoldingToSliding(characterStateManager, duration);
	}
