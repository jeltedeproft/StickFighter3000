...
import jelte.mygame.logic.character.state.CharacterStateLanding;
...
public class TestCharacterStateLanding {

	private CharacterStateManager characterStateManager;
	private CharacterStateLanding characterState;
	...
	public void setup() {
		...
		characterState = new CharacterStateLanding(characterStateManager, duration);
	}
