...
import jelte.mygame.logic.character.state.CharacterStateIdleCrouch;
...
public class TestCharacterStateIdleCrouch {

	private CharacterStateManager characterStateManager;
	private CharacterStateIdleCrouch characterState;
	...
	public void setup() {
		...
		characterState = new CharacterStateIdleCrouch(characterStateManager);
	}
