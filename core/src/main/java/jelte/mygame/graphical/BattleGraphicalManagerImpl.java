...
@Getter
public class BattleGraphicalManagerImpl implements GraphicalManager {

	private static final String TAG = BattleGraphicalManagerImpl.class.getSimpleName();
	...
	public BattleGraphicalManagerImpl(MessageListener messageListener) {
